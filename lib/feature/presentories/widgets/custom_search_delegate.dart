...
import 'package:rick_and_morty/feature/presentories/widgets/search_result.dart';
...
class CustomSearchDelegate extends SearchDelegate {
  ...
  Widget buildResults(BuildContext context) {
    ...
    BlocProvider.of<PersonSearchBloc>(context, listen: false)
        .add(SearchEvent.searchPerson(personQuery: query));
    ...
    return BlocBuilder<PersonSearchBloc, PersonSearchState>(
      builder: (context, state) {
        return state.when(
          ...
          error: (message) => _showErrorText(message),
        );
      },
    );
  }
